...
```bash
git clone https://github.com/engbasemm/hyper-ISP.git
cd hyper-ISP
```
...
```bibtex
@article{hyper-isp,
  title={\title{Hyper-ISP: Physics-Informed ISP Adapters with Unusually High Parameter Efficiency for Low-Light and High Dynamic Range Object Detection}},
  author={Basem Barakat , Muhammad Islam , Emad Rasmy and El sayed Hymaied},
...
[!Star History Chart](https://star-history.com/#yourusername/simplified-isp&Date)
